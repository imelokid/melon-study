...
import cn.melonkid.study.PathUtil;
import java.io.File;
...
public class ClasspathPackageScanner implements PackageScanner {
    ...
    public static void main(String[] args) throws Exception {
        PackageScanner scan = new ClasspathPackageScanner("cn.melonkid.study");
        List<String> classLis = scan.getFullyQualifiedClassNameList();
        for(String clazzPath : classLis) {
